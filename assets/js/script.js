...
class PortfolioApp {
    ...
    if (this.isDarkTheme) {
      ...
      if (profileImage) {
        this.switchProfileImage(
          profileImage,
          "Aku.jpg",
          "Kholid Azaki - Mahasiswa Teknik Informatika",
  ...
  initTypingEffect() {
    ...
    const roles = ["Penetration testing", "Gamer", "Explorer"];
      ...
      this.projects = [
        {
          ...
          description:
            "A responsive personal website showcasing projects with modern design patterns and animations.",
          technologies: ["HTML5", "CSS3", "JavaScript"],
          category: "web",
          githubUrl: "https://github.com/jeckxploit",
          liveUrl: "#",
          featured: true,
        },
        {
          ...
          description:
            "Full-stack web application for task management with real-time updates and user authentication.",
          technologies: ["python"],
          category: "web",
          githubUrl: "https://github.com/jeckxploit",
          liveUrl: "#",
        ...
        },
        {
          ...
          description:
            "Intelligent chatbot using natural language processing for automated customer support.",
  ...
  handleContactForm(e) {
    ...
    fetch("/", {
      ...
      .catch((error) => {
        ...
        this.showNotification(
          "❌ Failed to send message. Please try emailing me directly at rushiofficial1205@gmail.com",
          "error"
        );
      })
      .finally(() => {
